# WARNUNG! Aus unbekannten Gründen wurden alle Schrägstriche entfernt!
# Der Code wird deswegen nicht ganz funtkioneren.
# Aber wer den Code trotzdem haben will, hier isser:
...
def info()
    webbrowser.open('httpgithub.comnsdepwc')

def info2()
    webbrowser.open('httpshilfe.aol.dearticlestipps-fur-starke-passworter')
...
fenster.iconphoto(False, tk.PhotoImage(file='CStyxPasswortCheckerassetspicturesicon.png'))
...
#BG 'CStyxPasswortCheckerassetspicturesbg.png'

titel = tk.Label(fenster,text='Passwort Checker 3.0 Ultra n',fg='white',bg='#0054C2', font=('Calibri Light', 25),anchor='sw')
titel.pack()
...
disclaimer = tk.Label(fenster,text='Geben Sie niemals ihr echtes Passwort an! n Erstellt von NeoStyxDE. Informationen auf github.comnsde.',fg='white',bg='#0054C2',font=('arial', 7, 'italic'))
disclaimer.pack()
